...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="row">
          <div class="col-md-2">
                <a href="{{ route('admin.estados.create') }}" class="btn btn-default">
...
<!-- ej -->
        ...
        @foreach ($estados as $estado)
          ...
          <tr>
            <td style="width:22%">
                <input type="checkbox" name="all">
                <a href="/admin/estados/edit/{{$estado->_id}}" class="btn btn-default">
                  <span class=" glyphicon glyphicon-pencil" aria-hidden="true"></span>Editar
                </a>
                <a href="/admin/estados/delete/{{$estado->_id}}" class="btn btn-default">
            ...
            <td>
              {{ ( ! empty($estado->country) ? $estado->country : '') }}
            </td>
            <td>
                 {{$estado->Created_date}}
            </td>
