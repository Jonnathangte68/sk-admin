...
<?php echo Form::open(array('route' => 'admin.subcategorias.store', 'method' => 'POST' , 'class' => 'form-horizontal')); ?>
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
      <input id="name" name="name" type="text" placeholder="" class="form-control input-md" value="<?php echo e($subcategoria->name); ?>">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">                     
        <textarea class="form-control" id="description" name="description" value="<?php echo e($subcategoria->description); ?>"></textarea>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-5">
      <input id="category" name="category" type="text" placeholder="" class="form-control input-md"  value="<?php echo e($subcategoria->category); ?>">
