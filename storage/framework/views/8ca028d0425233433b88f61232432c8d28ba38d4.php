...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="row">
          <div class="col-md-2">
                <a href="<?php echo e(route('admin.estados.create')); ?>" class="btn btn-default">
...
<!-- ej -->
        ...
        <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $estado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr>
            <td style="width:22%">
                <input type="checkbox" name="all">
                <a href="/admin/estados/edit/<?php echo e($estado->_id); ?>" class="btn btn-default">
                  <span class=" glyphicon glyphicon-pencil" aria-hidden="true"></span>Editar
                </a>
                <a href="/admin/estados/delete/<?php echo e($estado->_id); ?>" class="btn btn-default">
                  <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Eliminar
                </a>
            </td>
            <td>
                <?php echo e($estado->_id); ?>

            </td>
            <td>
                 <?php echo e($estado->name); ?>

            </td>
            <td>
              <?php echo e(( ! empty($estado->country) ? $estado->country : '')); ?>

            </td>
            <td>
                 <?php echo e($estado->Created_date); ?>
      ...
      <div style="width: 40%;max-width: 40%;overflow-y: auto;float: right;clear: both;">
          <table id="pag_footer_num_pages">
              <tbody>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        var p = <?php echo json_encode($estados);; ?>;
    </script>
