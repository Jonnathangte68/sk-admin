<?php $__env->startSection('content'); ?>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="container">
                    ...
                    <a href="<?php echo e(route('admin.edit_page', 'about')); ?>" class="btn btn-primary full-button">Edit Page</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card">
                <img src="<?php echo e(asset('/assets/app/img/termsConditionsIcon.jpg')); ?>" alt="Terms & conditions" style="width:100%;height: 180px;">
                <div class="container">
                    <h4 class="text-center-ti"><b>Terms</b></h4>
                    <p class="text-center-ti">Terms & conditions...</p>
                    <a href="<?php echo e(route('admin.edit_page', 'terms')); ?>" class="btn btn-primary full-button">Edit Page</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card">
                <img src="<?php echo e(asset('/assets/app/img/langs.jpg')); ?>" alt="Languages" style="width:100%;height: 180px;">
                <div class="container">
                    <h4 class="text-center-ti"><b>Language</b></h4>
                    <p class="text-center-ti">Language Page</p>
                    <a href="<?php echo e(route('admin.edit_page', 'lang')); ?>" class="btn btn-primary full-button">Edit Page</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex-grid-thirds">
        <div class="col">
            <div class="card">
                <img src="<?php echo e(asset('/assets/app/img/comm.jpg')); ?>" alt="Languages" style="width:100%;height: 180px;">
                <div class="container">
                    <h4 class="text-center-ti"><b>Contact Us</b></h4>
                    <p class="text-center-ti">Contact Us page</p>
                    <a href="<?php echo e(route('admin.edit_page', 'contact')); ?>" class="btn btn-primary full-button">Edit Page</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card">
                <img src="<?php echo e(asset('/assets/app/img/landingpage1.jpg')); ?>" alt="Languages" style="width:100%;height: 180px;">
                <div class="container">
                    <h4 class="text-center-ti"><b>Landing</b></h4>
                    <p class="text-center-ti">First customer presented screen</p>
                    <a href="<?php echo e(route('admin.edit_page', 'landing')); ?>" class="btn btn-primary full-button">Edit Page</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card">
                <img src="<?php echo e(asset('/assets/app/img/signupbutton.png')); ?>" alt="Languages" style="width:100%;height: 180px;">
                <div class="container">
                    <h4 class="text-center-ti"><b>Talent Register</b></h4>
                    <p class="text-center-ti">Sign up page for talent</p>
                    <a href="<?php echo e(route('admin.edit_page', 'talent_signup')); ?>" class="btn btn-primary full-button">Edit Page</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="flex-grid-thirds">
        <div class="col">
            <div class="card">
                <img src="<?php echo e(asset('/assets/app/img/recruiterregisterImg.png')); ?>" alt="Languages" style="width:100%;height: 180px;">
                <div class="container">
                    <h4 class="text-center-ti"><b>Recruiter Register</b></h4>
                    <p class="text-center-ti">Sign up Recruiter page</p>
                    <a href="<?php echo e(route('admin.edit_page', 'recruiter_signup')); ?>" class="btn btn-primary full-button">Edit Page</a>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card">
                <img src="<?php echo e(asset('/assets/app/img/lockauthenticate.png')); ?>" alt="Languages" style="width:100%;height: 180px;">
                <div class="container">
                    <h4 class="text-center-ti"><b>Sign In</b></h4>
                    <p class="text-center-ti">Sign In page</p>
                    <a href="<?php echo e(route('admin.edit_page', 'signin')); ?>" class="btn btn-primary full-button">Edit Page</a>
                </div>
            </div>
        </div>
        <div class="col">
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="container">
                    ...
                    <a href="<?php echo e(route('admin.edit_page', 'about_us')); ?>" class="btn btn-primary">Edit Page</a>
                </div>
            </div>
        </div>
    </div>-->
