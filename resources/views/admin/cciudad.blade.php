...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="row">
          <div class="col-md-2">
                <a href="{{ route('admin.ciudades.create') }}" class="btn btn-default">
...
<!-- ej -->
        ...
        @foreach ($ciudades as $ciudad)
          ...
          <tr>
            <td style="width:22%">
                <input type="checkbox" name="all">
                <a href="/admin/ciudades/edit/{{$ciudad->_id}}" class="btn btn-default">
                  <span class=" glyphicon glyphicon-pencil" aria-hidden="true"></span>Editar
                </a>
                <a href="/admin/ciudades/delete/{{$ciudad->_id}}" class="btn btn-default">
            ...
            <td>
              {{ ( ! empty($ciudad->state) ? $ciudad->state : '') }}
            </td>
            <td>
                 {{$ciudad->Created_date}}
            </td>
