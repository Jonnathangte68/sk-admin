...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="row">
          <div class="col-md-2">
                <a href="{{ route('admin.niveles.create') }}" class="btn btn-default">
...
<!-- ej -->
        ...
        @foreach ($niveles as $nivel)
          ...
          <tr>
            <td style="width:22%">
                <input type="checkbox" name="all">
                <a href="/admin/niveles/edit/{{$nivel->_id}}" class="btn btn-default">
                  <span class=" glyphicon glyphicon-pencil" aria-hidden="true"></span>Editar
                </a>
                <a href="/admin/niveles/delete/{{$nivel->_id}}" class="btn btn-default">
            ...
            <td>
              {{ ( ! empty($nivel->description) ? $nivel->description : '') }}
            </td>
            <td>
              {{ ( ! empty($nivel->status) ? $nivel->status : '') }}
            </td>
            <td>
                 {{$nivel->Created_date}}
            </td>
