...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="row">
          <div class="col-md-2">
                <a href="<?php echo e(route('admin.subcategorias.create')); ?>" class="btn btn-default">
...
<!-- ej -->
        ...
        <?php $__currentLoopData = $subcategorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr>
            <td style="width:22%">
                <input type="checkbox" name="all">
                <a href="/admin/subcategorias/edit/<?php echo e($subcategoria->_id); ?>" class="btn btn-default">
                  <span class=" glyphicon glyphicon-pencil" aria-hidden="true"></span>Editar
                </a>
                <a href="/admin/subcategorias/delete/<?php echo e($subcategoria->_id); ?>" class="btn btn-default">
                  <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Eliminar
                </a>
            </td>
            <td>
                <?php echo e($subcategoria->_id); ?>
            ...
            <td>
              <?php echo e(( ! empty($subcategoria->description) ? $subcategoria->description : '')); ?>

            </td>
            <td>
                 <?php echo e($subcategoria->status); ?>

            </td>
            <td>
                 <?php echo e(( ! empty($subcategoria->category) ? $subcategoria->category : '')); ?>

            </td>
            <td>
                 <?php echo e($subcategoria->Created_date); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        var p = <?php echo json_encode($subcategorias);; ?>;
    </script>
