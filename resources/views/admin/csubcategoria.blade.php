...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="row">
          <div class="col-md-2">
                <a href="{{ route('admin.subcategorias.create') }}" class="btn btn-default">
...
<!-- ej -->
        ...
        @foreach ($subcategorias as $subcategoria)
          ...
          <tr>
            <td style="width:22%">
                <input type="checkbox" name="all">
                <a href="/admin/subcategorias/edit/{{$subcategoria->_id}}" class="btn btn-default">
                  <span class=" glyphicon glyphicon-pencil" aria-hidden="true"></span>Editar
                </a>
                <a href="/admin/subcategorias/delete/{{$subcategoria->_id}}" class="btn btn-default">
            ...
            <td>
              {{ ( ! empty($subcategoria->description) ? $subcategoria->description : '') }}
            </td>
            <td>
                 {{ $subcategoria->status }}
            </td>
            <td>
                 {{ ( ! empty($subcategoria->category) ? $subcategoria->category : '') }}
            </td>
            <td>
                 {{$subcategoria->Created_date}}
            </td>
          </tr>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var p = {!! json_encode($subcategorias); !!};
    </script>
