...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="row">
          <div class="col-md-2">
                <a href="<?php echo e(route('admin.categorias.create')); ?>" class="btn btn-default">
...
<!-- ej -->
        ...
        <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr>
            <td style="width:22%">
                <input type="checkbox" name="all">
                <a href="/admin/categorias/edit/<?php echo e($categoria->_id); ?>" class="btn btn-default">
                  <span class=" glyphicon glyphicon-pencil" aria-hidden="true"></span>Editar
                </a>
                <a href="/admin/categorias/delete/<?php echo e($categoria->_id); ?>" class="btn btn-default">
                  <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Eliminar
                </a>
            </td>
            <td>
                <?php echo e($categoria->_id); ?>
            ...
            <td>
              <?php echo e(( ! empty($categoria->description) ? $categoria->description : '')); ?>

            </td>
            <td>
                 <?php echo e($categoria->status); ?>

            </td>
            <td>
                 <?php echo e($categoria->Created_date); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        var p = <?php echo json_encode($categorias);; ?>;
    </script>
