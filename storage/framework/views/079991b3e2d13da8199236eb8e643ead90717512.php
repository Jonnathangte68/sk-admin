...
<div class="panel panel-default">
  ...
  <div class="panel-body">
      <div class="row">
          <div class="col-md-2">
                <a href="<?php echo e(route('admin.niveles.create')); ?>" class="btn btn-default">
...
<!-- ej -->
        ...
        <?php $__currentLoopData = $niveles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nivel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr>
            <td style="width:22%">
                <input type="checkbox" name="all">
                <a href="/admin/niveles/edit/<?php echo e($nivel->_id); ?>" class="btn btn-default">
                  <span class=" glyphicon glyphicon-pencil" aria-hidden="true"></span>Editar
                </a>
                <a href="/admin/niveles/delete/<?php echo e($nivel->_id); ?>" class="btn btn-default">
                  <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Eliminar
                </a>
            </td>
            <td>
                <?php echo e($nivel->_id); ?>
            ...
            <td>
              <?php echo e(( ! empty($nivel->description) ? $nivel->description : '')); ?>

            </td>
            <td>
              <?php echo e(( ! empty($nivel->status) ? $nivel->status : '')); ?>

            </td>
            <td>
                 <?php echo e($nivel->Created_date); ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        var p = <?php echo json_encode($niveles);; ?>;
    </script>
