...
<div style="width: 100%;height: 35px;background-color: blue;margin-bottom:5%;">
  ...
  <div class="row" style="margin-bottom:2%;">
      ...
      <div class="col-md-7"><input id="name" name="name" type="text" placeholder="" class="form-control input-md" <?php if($e): ?> value="<?php echo e($e->name); ?>" <?php endif; ?>></div>
  </div>

    <div class="row" style="margin-bottom:2%;">
      <div class="col-md-5"><label for="moto">Moto:</label></div>
      <div class="col-md-7"><input id="moto" name="moto" type="text" placeholder="" class="form-control input-md" <?php if($e): ?> value="<?php echo e($e->moto); ?>" <?php endif; ?>></div>
  </div>

    <div class="row" style="margin-bottom:2%;">
      <div class="col-md-5"><label for="sub_moto">Sub Moto:</label></div>
      <div class="col-md-7"><input id="sub_moto" name="sub_moto" type="text" placeholder="" class="form-control input-md" <?php if(property_exists($e,'sub_moto')): ?> value="<?php echo e($e->sub_moto); ?>" <?php endif; ?>></div>
  </div>

    <div class="row" style="margin-bottom:2%;">
      <div class="col-md-5"><label for="email">Email:</label></div>
      <div class="col-md-7"><input id="email" name="email" type="text" placeholder="" class="form-control input-md" <?php if($e): ?> value="<?php echo e($e->email); ?>" <?php endif; ?>></div>
  </div>

      <div class="row" style="margin-bottom:2%;">
      <div class="col-md-5"><label for="phone">Phone:</label></div>
      <div class="col-md-7"><input id="phone" name="phone" type="text" placeholder="" class="form-control input-md" <?php if($e): ?> value="<?php echo e($e->phone); ?>" <?php endif; ?>></div>
  </div>

      <div class="row" style="margin-bottom:2%;">
      <div class="col-md-5"><label for="address_detail">Direccion Detallada:</label></div>
      <div class="col-md-7"><textarea id="address_detail" name="address_detail" style="width: 100%;" <?php if(property_exists($e,'address_detail')): ?> value="<?php echo e($e->address_detail); ?>" <?php endif; ?>></textarea></div>
  </div>

      <div class="row" style="margin-bottom:2%;">
      <div class="col-md-5"><label for="country">Pa&iacute;s:</label></div>
      <div class="col-md-7"><input id="country" name="country" type="text" placeholder="" class="form-control input-md" <?php if($e): ?> value="<?php echo e($e->country); ?>" <?php endif; ?>></div>
  </div>

      <div class="row" style="margin-bottom:2%;">
      <div class="col-md-5"><label for="state">Estado:</label></div>
      <div class="col-md-7"><input id="state" name="state" type="text" placeholder="" class="form-control input-md" <?php if($e): ?> value="<?php echo e($e->state); ?>" <?php endif; ?>></div>
  </div>

      <div class="row" style="margin-bottom:2%;">
      <div class="col-md-5"><label for="city">Ciudad:</label></div>
      <div class="col-md-7"><input id="city" name="city" type="text" placeholder="" class="form-control input-md" <?php if($e): ?> value="<?php echo e($e->city); ?>" <?php endif; ?>></div>
  </div>

        <div class="row" style="margin-bottom:2%;">
      <div class="col-md-5"><label for="zip_code">Codigo Zip:</label></div>
      <div class="col-md-7"><input id="zip_code" name="zip_code" type="text" placeholder="" class="form-control input-md" <?php if($e): ?> value="<?php echo e($e->zip_code); ?>" <?php endif; ?>></div>
  </div>
      ...
      <div class="col-md-7"><input id="logo_url" name="logo_url" class="input-file" type="file"></div>
              <?php if($e): ?> 
                  <?php if(property_exists($e,'logo_url')): ?>
                      <div class="col-md-12"><img src="<?php echo e($e->logo_url); ?>" style="width: 100%;height: 100%;" /></div>
                  <?php endif; ?>
              <?php endif; ?>
  </div>
