    ...
    <div class="left_col scroll-view">
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li>
                        <a href="{{ route('admin.text_management') }}">
                ...
                <ul class="nav side-menu">
                    <li>
                        ...
                        <ul class="nav child_menu">
                            ...
                            <li>
                                <a href="{{ route('admin.estados') }}">
                                    Estados
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.ciudades') }}">
                                    Ciudades
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.niveles') }}">
                                    Niveles
                                </a>
                            </li>
                            <li>
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li>
                        ...
                        <ul class="nav child_menu">
                            <li>
                                <a href="{{ route('admin.dynamic_titles') }}">
                                    Titulos
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.managmail') }}">
                                    Keywords
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.managtemplate') }}">
                                    Enlaces
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('admin.pages_all') }}">
                                    Paginas
                                </a>
                            </li>
                        </ul>
                        <!--<a href="{{ route('admin.dynamic_style') }}">
